      ...
      <div className="text-center max-w-2xl mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Your personal dashboard and content management system
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 backdrop-blur-sm bg-opacity-90">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-6">
              Manage your content and explore your dashboard
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-sm">Manage your banners</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-sm">Configure options</p>
          </div>
        </div>
